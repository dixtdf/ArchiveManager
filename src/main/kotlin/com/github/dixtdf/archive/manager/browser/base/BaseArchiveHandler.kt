package com.github.dixtdf.archive.manager.browser.base
    ...
    companion object {
        ...
        fun <T> createCache(
            ...
            return object : FileAccessorCache<BaseArchiveHandler<T>, T>(protectedQueueSize, probationalQueueSize) {
                override fun disposeAccessor(fileAccessor: T & Any) = onDispose(fileAccessor)

                override fun isEqual(val1: BaseArchiveHandler<T>?, val2: BaseArchiveHandler<T>?): Boolean =
                    onEqual(val1, val2)

                override fun createAccessor(key: BaseArchiveHandler<T>?): T & Any {
